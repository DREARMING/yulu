<%@ Page Title="" Language="C#" MasterPageFile="~/TopFoot.master" AutoEventWireup="true" CodeFile="book.aspx.cs" Inherits="book" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div id="left">
            <div id="tab_menu">
                <div style="padding:10px 40px; background-image: url('pictures/opacitybg.png');">
                    ...
                    <span >书本语录集</span><span><a href="#">最新</a>   <a href="#">最热</a></span>
                </div>
            </div>                                               
        <div id="tab_box">
            <%--最热----%>
                        ...
                        <table cellpadding="3" style="width:190px;height:160px;">
                            ...
                            <tr>
                                <td style="font-size:12pt;">收集语录（<%#Eval("numOfSentences") %>）
                                    <asp:ImageButton ID="ILoveIt" runat="server" ImageUrl="~/pictures/heart2.png" OnClick="ILoveIt_Click" CommandArgument='<%# Eval("book_id") %>' /><asp:Label ID="lovenum_label_sentence" runat="server"  Text='<%# Eval("numOfFavorite") %>' Font-Size="8pt"></asp:Label>
                                </td>
                            </tr>
                        </table>
                        <br />
        ...
        <div id="right">
            ...
            <div class="booksentence">
                <div style="padding:5px 10px;font-size:14pt;font-weight:bold;">
                    <div style="float:left">书籍语录动态</div>
                ...
                <ItemTemplate>
                    <table width="280px"cellspacing="10px" style="height:50px">
                        <tr>
                            ...
                            <td><%# Eval("info") %></td>
                            <td><asp:ImageButton ID="ILoveIt" runat="server" ImageUrl="~/pictures/heart2.png" OnClick="ILoveIt_Click" CommandArgument='<%# Eval("Sentence_id") %>' /><asp:Label ID="lovenum_label_sentence" runat="server"  Text='<%# Eval("numOfFavorite") %>' Font-Size="8pt"></asp:Label></td>
                        </tr>
                    </table>
                </ItemTemplate>
                </asp:DataList>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:Web_DBConnectionString2 %>"             
            
            SelectCommand="SELECT * FROM [SentenceSet] WHERE ([class] = @class) ORDER BY [createTime] DESC, [numOfSentences] DESC">
        <SelectParameters>
            <asp:Parameter DefaultValue="book" Name="class" Type="String" />
        </SelectParameters>
        </asp:SqlDataSource>
